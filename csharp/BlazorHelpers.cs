...
namespace MsoRewConverter.Blazor
{
    /// <summary>
    ...
    public class ConversionOptionsUI
    {
        ...
        public bool ExcludeGainBlock { get; set; } = true;

        public bool ExcludeDelayBlock { get; set; } = true;
        ...
        public ConversionOptions ToConversionOptions()
        {
            ...
            if (ExcludeGainBlock)
                excludedTypes.Add("Gain Block");
            
            if (ExcludeDelayBlock)
                excludedTypes.Add("Delay Block");
        ...
        public static ConversionOptionsUI FromConversionOptions(ConversionOptions options)
        {
            return new ConversionOptionsUI
            {
                ...
                ExcludeGainBlock = options.ExcludedTypes.Any(t => t.Contains("Gain Block", StringComparison.OrdinalIgnoreCase)),
                ExcludeDelayBlock = options.ExcludedTypes.Any(t => t.Contains("Delay Block", StringComparison.OrdinalIgnoreCase))
            };
        }
    }
